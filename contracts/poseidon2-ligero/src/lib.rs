#![no_std]
use soroban_sdk::{Env, U256, Vec, bytesn, symbol_short, vec};

/// BN254 scalar field modulus
pub fn bn254_fr_modulus(env: &Env) -> U256 {
...
/// Convenience: hash a single U256 element
pub fn poseidon2_hash_single(env: &Env, a: U256) -> U256 {
    let inputs = vec![env, a];
    poseidon2_hash(env, &inputs)
}

/// Convenience: hash a pair of U256 elements
pub fn poseidon2_hash_pair(env: &Env, a: U256, b: U256) -> U256 {
